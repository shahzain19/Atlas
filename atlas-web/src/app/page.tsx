      ...
      <section className="pb-28 pt-8">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <a href="https://github.com/shahzain19/Atlas" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm border border-[#e5e5e5] text-black hover:border-black transition-all">
